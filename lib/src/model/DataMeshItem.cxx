...
DataMeshItem::DataMeshItem(const DataFieldModel& dataModel)
  : DataFieldModelItem(dataModel, "DataMeshItem")
{
...
void DataMeshItem::buildActions()
{
...
void DataMeshItem::update(Observable* /*source*/, const String & message)
{
