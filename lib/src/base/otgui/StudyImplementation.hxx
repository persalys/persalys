 ...
 *
 */
#ifndef OTGUI_STUDYIMPLEMENTATION_HXX
#define OTGUI_STUDYIMPLEMENTATION_HXX
...
namespace OTGUI
{
class OTGUI_API StudyImplementation : public OT::PersistentObject, public Observable, public Observer
{
  CLASSNAME
