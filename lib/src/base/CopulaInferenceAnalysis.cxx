...
{
  return CopulaInferenceAnalysis::CanBeLaunched(errorMessage, designOfExperiment_);
}
...
bool CopulaInferenceAnalysis::CanBeLaunched(String &errorMessage, const DesignOfExperiment &doe)
{
