...
QuadraticCumulCalculusResultWindow::QuadraticCumulCalculusResultWindow(DistributionAnalysisItem * item)
  : OTguiSubWindow(item)
  , result_(dynamic_cast<QuadraticCumulCalculus*>(&*item->getCalculus().getImplementation())->getResult())
{
  buildInterface();
}


void QuadraticCumulCalculusResultWindow::buildInterface()
{
...
void QuadraticCumulCalculusResultWindow::updateLabelsText(int indexOutput)
{
  // first order mean
