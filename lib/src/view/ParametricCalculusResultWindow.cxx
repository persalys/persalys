...
void ParametricCalculusResultWindow::updateLabelsText(int indexOutput)
{
  // min
  OSS oss1;
...
void ParametricCalculusResultWindow::inputScatterPlotChanged(int index)
{
  updateScatterPlot(index, outputsComboBoxSecondTab_->currentIndex());
}


void ParametricCalculusResultWindow::outputScatterPlotChanged(int index)
{
  updateScatterPlot(inputsComboBox_->currentIndex(), index);
}


void ParametricCalculusResultWindow::updateScatterPlot(int indexInput, int indexOutput)
{
