...
design_0.run()
metaModel_0 = persalys.FunctionalChaosAnalysis("metaModel_0", design_0.getResult().getDesignOfExperiment())
...
design_0.setInterestVariables(interestVariables)
design_0.run()
metaModel_0 = persalys.KrigingAnalysis("metaModel_0", design_0.getResult().getDesignOfExperiment())
