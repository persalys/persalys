...
upperBounds = [1.1, 2.2]
levels = [2, 2]
aDesign = otguibase.GridDesignOfExperiment('aDesign_1', model, lowerBounds, upperBounds, levels)
...
aDesign2 = otguibase.ImportedDesignOfExperiment('aDesign_2', model, filename, [0, 2])
