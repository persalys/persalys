...
input_file.setVariables(
    ["X0", "X1", "X2"], ["@X0", "@X1", "@X2"], ["{:10.6f}", "{:10.6f}", "{:10.6f}"]
)
...
step = persalys.CouplingStep(
    sys.executable + " external_program.py input.txt",
    [input_file],
    [resource_file],
    [output_file],
)
...
step = persalys.CouplingStep(
    sys.executable + " program.py input.txt",
    [input_file],
    [resource_file],
    [output_file],
)
...
step1 = persalys.CouplingStep(
    sys.executable + " program1.py", [input_file], [resource_file], [output_file]
)
...
step2 = persalys.CouplingStep(
    sys.executable + " program2.py", [input_file], [resource_file], [output_file]
)
...
step3 = persalys.CouplingStep(
    sys.executable + " program3.py", [input_file], [resource_file], [output_file]
)
