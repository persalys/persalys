...
analysis.setMaximumCallsNumber(150)
...
analysis.setMaximumConstraintError(1e-6)
analysis.run()
cstr = analysis.defineProblem().getInequalityConstraint().getEvaluation().getImplementation()
print(cstr)
point = analysis.getResult().getFinalPoints()
print(cstr(point.getMarginal(cstr.getInputPositions())))
